...
# ╔═╡ 9a07191c-a064-11f0-1964-91c1f8b8b777
using H3, GeoMakie, CairoMakie, PlutoUI; using H3.API; PlutoUI.TableOfContents()

# ╔═╡ 521d4579-8d83-4f74-9113-08e8f813396e
md"# API"

# ╔═╡ 217e645e-ebb2-407a-ac8d-217c505dc026
lat, lon = (37.7955,  -122.3937)

# ╔═╡ 1a62badb-8639-41c5-9d16-9507db1efb92
res = 1

# ╔═╡ c549b475-f977-483a-b032-ea67235f1b3e
latlng = LatLng(deg2rad(lat), deg2rad(lon))

# ╔═╡ f8aed6f2-8d65-4f60-b6f9-b0380c65a6f3
cell = latLngToCell(latlng, res)

# ╔═╡ 203770da-efe6-4061-8d5a-e76eb98e18bb
cellToLatLng(cell) 

# ╔═╡ 26ad6f04-1339-4956-ac3f-62c74222e625
boundary = cellToBoundary(cell)

# ╔═╡ a52aaaa4-1175-479c-8f1c-9d870ba3a983
boundary2 = map(boundary) do x 
	(rad2deg(x.lng), rad2deg(x.lat))
end

# ╔═╡ 5f4bcee4-69c1-4401-99aa-ed6bec0dcddc
let 
	fig = Figure()
	ax = Axis(fig[1,1])
...
H3 = "f62fece2-b996-571a-b4c9-e662aba1c617"
...
manifest_format = "2.0"
project_hash = "0c92cc2bb5d5101d0dbe24c7dc1dc87df907acab"
...
git-tree-sha1 = "22fe822256d7f7064f09cba9214c4990cf4c0664"
...
[[deps.H3]]
deps = ["CEnum", "H3_jll", "Libdl"]
git-tree-sha1 = "faef10ad861f35c50fc9879122194392a3fb96e1"
uuid = "f62fece2-b996-571a-b4c9-e662aba1c617"
version = "0.3.2"

[[deps.H3_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl"]
git-tree-sha1 = "4e99ccf48520ec137c469b6fa5f6390b09a6aa51"
uuid = "60c8821e-da38-5dbd-93c7-983f1e6d69be"
version = "4.2.1+0"
