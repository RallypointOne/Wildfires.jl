...
# ╔═╡ 312f8f46-88d4-11f0-2789-25c00563bdef
begin 
...
manifest_format = "2.0"
project_hash = "59c6f2ed8d2dd38e446cf3dfd174867e4a2a4ac2"
...
git-tree-sha1 = "2cf994e66a0886a91ba108cb3cfc044363f0bb01"
...
[[deps.SpeedyWeather]]
deps = ["AbstractFFTs", "Adapt", "AssociatedLegendrePolynomials", "BitInformation", "CodecZlib", "Dates", "DocStringExtensions", "FFTW", "FastGaussQuadrature", "GPUArrays", "GenericFFT", "JLD2", "KernelAbstractions", "LinearAlgebra", "NCDatasets", "Primes", "Printf", "ProgressMeter", "Random", "Statistics", "TOML"]
git-tree-sha1 = "935e63971646b56c80f62ab1ec459708e0eba501"
uuid = "9e226e20-d153-4fed-8a5b-493def4f21a9"
version = "0.16.0"

    [deps.SpeedyWeather.extensions]
    ...
    SpeedyWeatherUnicodePlotsExt = "UnicodePlots"

    [deps.SpeedyWeather.weakdeps]
    CUDA = "052768ef-5323-5732-b1bb-66c8b64840ba"
    Enzyme = "7da242da-08ed-463a-9acd-ee780be4f1d9"
