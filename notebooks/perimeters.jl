...
# ╔═╡ 4117f40e-88fc-11f0-37af-b3d019d4cb4c
begin 
	using Shapefile, Plots, GeoJSON, GeoInterface, DataFrames, StatsBase, WebIO, Leaflet, GADM
end

# ╔═╡ f8ec1688-5209-4f6e-bc21-83ddca7d98bc
df = let 
	path = "/Users/joshday/.julia/dev/Wildfires/data/National_USFS_Fire_Perimeter_(Feature_Layer).geojson"
	DataFrame(GeoJSON.read(path))
end

# ╔═╡ 0ee0ce8c-d29a-478c-8356-a6b1eac12209
df_marshall = filter(df) do row 
	!ismissing(row.FIRENAME) && 
		lowercase(row.FIRENAME) == "marshall"
end

# ╔═╡ 69eee444-79e5-4f2c-9505-5feecc19b7c6
plot(df_marshall.geometry[3], lw=2, lc = :red, c = :red)

# ╔═╡ bde4843c-f856-44a7-be17-019066432637
begin
	layers = Leaflet.Layer(df_marshall.geometry[3]); 
...
Leaflet = "2ed2781b-9bfa-45ba-823d-d31db75b7d93"
...
manifest_format = "2.0"
project_hash = "37ac90eb92192c8664c5b8d550fb05ff27b8cacb"
...
[[deps.Leaflet]]
deps = ["Colors", "GeoInterface", "GeoJSON", "JSON3", "TileProviders", "UUIDs", "WebIO"]
git-tree-sha1 = "723dfb6db465ea6a8924989f408a31afd2860f25"
