...
# ╔═╡ 8ea435da-9e09-11f0-1081-05c33e9b6e65
begin
	using PlutoUI
	using Dates
	import Cobweb

	ENV["RASTERDATASOURCES_PATH"] = mkpath("/Users/joshday/rasterdatasources")

	PlutoUI.TableOfContents()
end

# ╔═╡ 1ae72c6c-31ed-417c-968e-a20a172635dd
using CairoMakie, GeoMakie, DataFrames

# ╔═╡ 289872d7-39ae-4654-afbe-0485f12bf2a5
md"""
# Core Packages
"""

# ╔═╡ 5fff1645-1979-4344-b88a-3adf03101306
import GeoInterface as GI

# ╔═╡ c047d0b5-e9e8-4a21-a14c-9175c6adfd7a
import GeometryOps as GO

# ╔═╡ 728971ca-5e7f-454f-8428-d684da6132f4
md"""
# GMT.jl

- Tons of features, including geocoding.
- Includes some "remote" datasets: [https://www.generic-mapping-tools.org/remote-datasets/index.html](https://www.generic-mapping-tools.org/remote-datasets/index.html)
"""

# ╔═╡ 3eead796-bb44-4b24-be95-1dff4ea0bc5b
import GMT

# ╔═╡ 3891927a-5b43-4eba-9dab-695cc472905e
begin
	# Geocoding
	loc = GMT.geocoder("Chapel Hill, NC")

	# Attributes of the location
	loc.attrib
end

# ╔═╡ ad99f7f6-25e7-49bb-9eaa-1e7a2ec3c27b
let
	x = GMT.gmtread(GMT.remotegrid("earth_relief", res="10m"))
	
	heatmap(x', axis=(; aspect=DataAspect()))
end

# ╔═╡ 6a11499a-01c8-4ab4-bfca-0f4084d81abf
md"""
# [RasterDataSources.jl](https://github.com/EcoJulia/RasterDataSources.jl)

- Datasets aren't discoverable through the package itself.  Need to read docs for each individual data source.
"""

# ╔═╡ 6da15d3c-b61c-447a-bdc9-8d624918229d
import Rasters, ArchGDAL, Proj

# ╔═╡ 1e81f519-7a18-491d-938f-602efea8ceca
import RasterDataSources as RDS

# ╔═╡ 35bd5e8d-8910-4518-bdbb-75a30936a0a1
md"## MODIS"

# ╔═╡ fa5da52a-2b26-4a82-bd3e-56d443a77b2a
# let 
# 	loc = GMT.geocoder("Chapel Hill, NC")
# 	lon, lat = loc.data
# 	file = RDS.getraster(RDS.MOD13Q1, :NDVI; lon, lat, km_ab=20, km_lr=20, date=Date(2025))
# 	r = Rasters.Raster(file)
# 	plot(r)
# end

# ╔═╡ 470a71ac-4fe8-4ab0-883b-45884ea51f52
md"""
# GADM.jl

- [https://gadm.org/](https://gadm.org/)
- (Multi)polygons of countries and their subdivisions
"""

# ╔═╡ ef464fb7-ba5d-4764-b790-7f0769c3308c
import GADM

# ╔═╡ fc38e33e-1ea5-4d9b-86f6-a943abfbdd3e
# let 
# 	table = GADM.get("USA", "North Carolina", depth=1)

# 	df = DataFrame(table)

# 	poly(df.geom, axis=(; aspect=DataAspect()))
# end

# ╔═╡ 62082035-8918-43c4-8b31-2d48e97a4184
md"""
# [NaturalEarth.jl](https://github.com/JuliaGeo/NaturalEarth.jl)

- Datasets from [https://github.com/nvkelso/natural-earth-vector](https://github.com/nvkelso/natural-earth-vector)
"""

# ╔═╡ c0f748d4-9b03-4c76-ac07-6e12c4612aa1
import NaturalEarth

# ╔═╡ 72eb692c-da71-4f77-b8ca-74eff9cb9f5e
# poly(NaturalEarth.bathymetry().geometry)

# ╔═╡ 504eb215-9f52-4b84-9359-9f2e23ca5917
# poly(NaturalEarth.naturalearth("10m_admin_0_countries").geometry)

# ╔═╡ 9fb7704d-18ba-484f-bea7-5e4a14782263
# lines(NaturalEarth.naturalearth("10m_coastline"))

# ╔═╡ 2454fe74-1596-4e5a-beaf-cea326353db3
md"""
# STAC.jl
- [https://stacspec.org/en](https://stacspec.org/en)
"""

# ╔═╡ c06c1162-84a2-4831-acfe-97345ac9ae9c
import STAC

# ╔═╡ 928b6b56-e999-4b9a-ab69-737a4e2aa672
# let 
# 	url = "https://landsatlook.usgs.gov/stac-server/"

# 	catalog = STAC.Catalog(url)

# 	catalog["landsat-c2l2-st"]
# end
...
manifest_format = "2.0"
project_hash = "4962673cd0945706f4ab2838ebe1c2e55b635fd5"
...
git-tree-sha1 = "43163db588debaae1454e03fab68887236f585ca"
...
git-tree-sha1 = "b9468f50b487161a1ea6c67f7f09043934de39b0"
uuid = "3cb90ccd-e1b6-4867-9617-4276c8b2ca36"
version = "0.7.1"
weakdeps = ["Proj"]

    [deps.RasterDataSources.extensions]
    RasterDataSourcesProjExt = "Proj"
