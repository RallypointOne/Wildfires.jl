...
model = RothermelModel(SHORT_GRASS, NoWind(), UniformMoisture(M), FlatTerrain())

trace = Trace(g, 2)
simulate!(g, model, steps=80, residence_time=8.0, trace=trace)
firegif(joinpath(@__DIR__, "ca_hero.gif"), trace, g)
```
